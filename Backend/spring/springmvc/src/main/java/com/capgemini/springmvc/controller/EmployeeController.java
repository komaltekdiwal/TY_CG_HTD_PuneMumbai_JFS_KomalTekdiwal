...
public class EmployeeController {
	...
	@Autowired              //we don't create object
	...
	public String addEmployee(EmployeeInfoBean employeeInfoBean, HttpSession session,
			ModelMap modelMap) {
		...
		if(session.isNew()) {
			...
			if(service.addEmployee(employeeInfoBean)) {
				modelMap.addAttribute("msg","Added Employee Successfully!");
			}else {
	...
	public String updateEmployee(EmployeeInfoBean employeeInfoBean, HttpSession session,
			ModelMap modelMap) {
